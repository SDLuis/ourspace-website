  ...
  <div className='sm:px-8 px-0'>
    <main className='min-h-screen w-full sm:w-[90.5%] flex justify-center'>
      <div className='w-full sm:w-[598px] md:w-[470px] lg:w-[598px] py-5 flex flex-col items-center border-b border-x border-solid sm:border-gray-500'>
        <ContentLoader className='w-[90%] sm:w-[440px] xl:w-[430px]' viewBox='0 0 400 460' {...props}>
          <circle cx='31' cy='31' r='15' />
          <rect x='58' y='18' rx='2' ry='2' width='140' height='10' />
          <rect x='58' y='34' rx='2' ry='2' width='140' height='10' />
          <rect x='0' y='60' rx='2' ry='2' width='140' height='10' />
          <rect x='0' y='78' rx='2' ry='2' width='525' height='300' />
        </ContentLoader>
      </div>
    </main>
  </div>
