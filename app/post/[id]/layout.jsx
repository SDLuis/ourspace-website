...
export default async function Post ({ params, children }) {
  ...
  return (
    <main className='w-full min-h-screen flex justify-center text-white'>
      <div className='w-full flex p-4 gap-2 mb-1 relative justify-center sm:w-[598px] md:w-[470px] lg:w-[598px] sm:border-x sm:border-b border-solid sm:border-gray-700'>
