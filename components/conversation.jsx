...
export default function Conversation ({ conversation }) {
  const { friend, loading } = UseConversation({ conversation })
  if (loading) return <div className='w-60 flex justify-center items-center'> <div className='h-10 w-10'><Loading /></div></div>
  return (
