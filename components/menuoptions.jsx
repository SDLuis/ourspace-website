...
export default function MenuOptions ({ removePost, post, OwnerPost } = {}) {
  ...
  return (
    <div>
      <div hidden={OwnerPost(post.userModel)} onClick={() => setShow(!show)} className='text-gray-200 absolute top-2 right-3 p-0.5 dark:hover:bg-gray-900 hover:bg-gray-200 transition-all ease-in-out cursor-pointer rounded-full duration-200'><MoreOptions /></div>
