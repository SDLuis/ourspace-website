...
export default function Utilities () {
  ...
  return (
    <div className='w-[60px] 1xl:w-[270px] min-h-screen flex items-start rounded-md'>
      <div className='w-full border border-gray-700 min-h-[9rem] xl:min-h-[16rem] h-auto'>
        {
          loading
            ? <div className='w-full min-h-[10rem] xl:min-h-[16rem] h-auto flex justify-center items-center text-white'><div className='w-8 xl:w-20'><Loading /></div></div>
            : userFound
              ? <div className='w-full h-full'>
                ...
                <div className='flex-col gap-4 flex items-center w-full xl:hidden p-2'>
                  <Link href={`/user/${userFound.user}`}>
                    <Image width={48} height={48} className='rounded-full w-10 h-10 object-cover' src={img} alt='user' />
                  </Link>
                  <Link href='/user/edit'>
                    <Edit />
                  </Link>
