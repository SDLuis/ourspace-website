...
export default async function Posts () {
  ...
  return (
    posts.map((post) => (
      <div className='flex flex-col p-5 w-[440px] border-solid border rounded-md mb-5 bg-[#000009] border-gray-500' key={post.Post_ID}>
        ...
        <img width={400} height={500} className='object-cover rounded-md w-[400px] h-[500px]' src={post.img} alt='post image' />
        <div className='pt-4'>
          {
